...
class BeautyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredProducts = allProducts.filter { it.category.equals("Beauty", ignoreCase = true) }
        ...
        Log.d("BeautyActivity", "Found: ${filteredProducts.size} beauty products")
    }
            ...
            if (checkedIds.isNotEmpty()) {
                when (checkedIds[0]) {
                    ...
                    R.id.chip_compare -> {
                        ...
                        intent.putExtra("CATEGORY", "Beauty")  // FIXED: Was "Clothing"
                        startActivity(intent)
                        // Restore previous chip selection
        ...
        searchView.editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    Log.d("BeautyActivity", "Search: $query, Results: ${results.size}")
                } else {
    ...
    private fun loadProductsFromJson(): List<Product> {
        return try {
            ...
            e.printStackTrace()
            Log.e("BeautyActivity", "Error reading products.json: ${e.message}")
            emptyList()
        }
    }
}
...
class PhoneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredProducts = allProducts.filter { it.category.equals("SmartPhones", ignoreCase = true) }
        ...
        Log.d("PhoneActivity", "Found: ${filteredProducts.size} phone products")
    }
        ...
        searchView.editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    Log.d("PhoneActivity", "Search: $query, Results: ${results.size}")
                } else {
    ...
    private fun loadProductsFromJson(): List<Product> {
        return try {
            ...
            e.printStackTrace()
            Log.e("PhoneActivity", "Error reading products.json: ${e.message}")
            emptyList()
        }
    }
}

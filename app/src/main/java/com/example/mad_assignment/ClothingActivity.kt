...
class ClothingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredProducts = allProducts.filter { it.category.equals("Clothing", ignoreCase = true) }
        ...
        Log.d("ClothingActivity", "Found: ${filteredProducts.size} clothing products")
    }
        ...
        searchView.editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    Log.d("ClothingActivity", "Search: $query, Results: ${results.size}")
                } else {
    ...
    private fun loadProductsFromJson(): List<Product> {
        return try {
            ...
            e.printStackTrace()
            Log.e("ClothingActivity", "Error reading products.json: ${e.message}")
            emptyList()
        }
    }
}

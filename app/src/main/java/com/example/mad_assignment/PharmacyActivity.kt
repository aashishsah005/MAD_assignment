...
class PharmacyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredProducts = allProducts.filter { it.category.equals("Pharmacy", ignoreCase = true) }
        ...
        Log.d("PharmacyActivity", "Found: ${filteredProducts.size} pharmacy products")
    }
        ...
        searchView.editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    Log.d("PharmacyActivity", "Search: $query, Results: ${results.size}")
                } else {
    ...
    private fun loadProductsFromJson(): List<Product> {
        return try {
            ...
            e.printStackTrace()
            Log.e("PharmacyActivity", "Error reading products.json: ${e.message}")
            emptyList()
        }
    }
}

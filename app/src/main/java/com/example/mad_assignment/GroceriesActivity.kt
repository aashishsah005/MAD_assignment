...
class GroceriesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredProducts = allProducts.filter { it.category.equals("Groceries", ignoreCase = true) }
        ...
        Log.d("GroceriesActivity", "Found: ${filteredProducts.size} groceries products")
    }
        ...
        searchView.editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    Log.d("GroceriesActivity", "Search: $query, Results: ${results.size}")
                } else {
    ...
    private fun loadProductsFromJson(): List<Product> {
        return try {
            ...
            e.printStackTrace()
            Log.e("GroceriesActivity", "Error reading products.json: ${e.message}")
            emptyList()
        }
    }
}
